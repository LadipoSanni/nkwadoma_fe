    ...
    return (
        ...
        >
            ...
            <div
                ...
                className={` ${styles.componentDivision}  grid grid-rows-2 bg-purple-100 w-full h-full md:flex  md:justify-between  pt-8 md:pt-4  md:w-full md:h-full  `}
            ...
            >
                <div
                    ...
                    className={` bg-red-300 grid gap-3 md:grid md:gap-6 md:w-fit md:h-fit   `}
                 >
                ...
                <div
                    className={`  overflow-x-hidden overflow-y-auto md:w-fit bg-lime-400  w-full md:h-fit border border-gray500 rounded-md md:px-4 md:py-4 px-3 py-3 grid gap-1 md:grid `}
                >
                   {/*<div*/}

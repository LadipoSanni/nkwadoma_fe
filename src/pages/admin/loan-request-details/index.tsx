...
const LoanDetails = () => {
    ...
    const component = [
        {"basicDetails": <LoanDetailsCard dataList={dataList}  />},
        {"AdditionalDetails": <LoanDetailsCard/>},
        {"LoanDetails": <LoanDetailsCard/>}
    ...
    return (
        ...
        >
            ...
            <div
                ...
                className={`w-full h-full md:flex  md:justify-between grid gap-5 pt-8 md:pt-4  md:w-full md:h-full  `}
            ...
            >
                ...
                >
                   ...
                   >
                    ...
                    {/*<LoanDetailsCard dataList={dataList}  />*/}

        ...
        <div className={` grid md:grid gap-4 md:gap-4 `}>
            ...
            <div className={`w-full md:w-full  rounded-md md:rounded-md py-4 px-4 md:px-3 md:py-3 md:bg-white bg-white   border border-[#D7D7D7] md:border   `}>
                <div className={`bg-grey105 grid gap-4 md:grid md:gap-3  md:bg-grey105 `}>
                    <PerformanceCard isSmall={false} showContainerBorder={false} percentage={'26.8'} showPerformancePercentage={true} maxWidth={'100%'} title={'Portfolio percentage'} value={30} isValueInPercentage={true} showMonthPick={true} didValueIncrease={true}/>

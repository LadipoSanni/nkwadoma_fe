...
function LoanProductPage() {
  ...
  return (
    <div className={`grid grid-cols-1  place-items-center   h-full`} id="loanProductPage">
      <div className="grid rounded bg-white w-[100%]  h-[85vh] " id='loanProductPageMainContainer'>
        <div
        ...
        <div  className={`w-[96%] bg-purple-300 mt-[1rem] h-[82%] mr-auto ml-auto`}>
                        <LoanProductTable tableData={loanProductData}  handleRowClick={handleRowClick} tableHeader={columns} tableHeight={59} sx='cursor-pointer'/>
                    </div>
      </div>
    </div>
  );

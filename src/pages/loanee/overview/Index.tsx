...
const LoaneeOverview = () => {
    ...
    return (
        <main id={'OverviewTr'}
            ...
            {/*{isLoaneeIdentityVerified && */}
                <button
                onClick={() => {
                    handleBannerClick()
                }}
                className={`${inter500.className} h-16 w-full mb-[20px] mt-[20px]  mb-[20px] md:p- py-4 px-3 flex gap-2 bg-warning150 border-[0.5px] border-[#F7C164] rounded-[6px]`}>

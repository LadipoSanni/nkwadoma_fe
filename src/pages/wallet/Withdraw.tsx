...
import WithdrawBigIcon from "@/components/icons/WithdrawBigIcon";
                    ...
                    <div className={` grid h-full  `}>
                        <div className={` grid h-fit gap-6  `}>
                            ...
                            <span>
                                ...
                                <div>
                                    <p className={` text-[#4D4E4D] ${inter.className} text-[10px] `}>Withdraw to</p>
        ...
        >
            ...
            <main className={` w-full px-2  md:px-8 grid gap-8   `}>
                ...
                >
                    <div>
                        <WithdrawBigIcon/>
                        <p className={` text-[20px] ${inter500.className} text-[#212221]  `}>Withdraw</p>
                    </div>
                ...
                <section  className={` md:flex  lg:flex md:justify-between lg:justify-between  md:w-[80%] mr-auto ml-auto grid   h-[60vh]    max-h-[60vh] md:max-h-[60vh]  `}>
                    <div className={` grid gap-2 h-fit `}>
                        <p className={` text-[#4D4E4D] text-[14px] ${inter.className} `}>Withdraw to</p>
                        <RadioCheckButton isChecked={true}  text={'Linked accounts'}  />
                    </div>

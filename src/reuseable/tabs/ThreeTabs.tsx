...
export const ThreeTabs: React.FC<detailContainerProps> = ({
    ...
    return (
        <div id="cohort-details" data-testid="cohort-details"
             className={`${inter.className} border border-slate-200 md:p-3 px-2 py-3 rounded-md`}>
                ...
                <div className={`w-full rounded-md`}>
                    ...
                    >
                        ...
                        <TabsContent value={"productDetails"} id="cohort-details-content"
                            ...
                            <div
                                className="bg-[#F9F9F9] min-h-[45vh] md:max-h-[56vh] px-5 w-full overflow-x-hidden md:overflow-y-auto rounded-sm">
                            ...
                            <TabsContent value={"termsAndCondition"} id="trainee-content" data-testid="trainee-content"
                                ...
                                {isTable ?
                                    ...
                                    :
                                    <div
                                        className="bg-[#F9F9F9] min-h-[45vh] md:max-h-[56vh] overflow-x-hidden px-5 w-full py-2 md:overflow-y-auto rounded-sm">
                                        <p
                                            id={`data-item`}

            ...
            <div className={'grid gap-2'}>
                ...
                <PatternFormat
                    ...
                    {...register("tin", {
                        ...
                        pattern: {
                            value: /^N-\d{8}$/,
                            message: "TIN must be in format N-12345678"
                        },
                        validate: {
                            validFormat: (value) => {
                                return /^N-\d{8}$/.test(value) || "TIN must be in format N-12345678";
                            }
                        },
                        onChange: (e) => {
                            setValue("tin", e.target.value, { shouldValidate: true });
                        }
                    })}
                    onValueChange={(values) => {
                        const { formattedValue } = values;
                        setValue("tin", formattedValue, { shouldValidate: true });
                    }}

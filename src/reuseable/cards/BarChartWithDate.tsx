    ...
    return (
        <div id={id} className={`w-full md:w-full  rounded-md md:rounded-md py-4 px-4 md:px-3 md:py-3 md:bg-white bg-white   border border-[#D7D7D7] md:border   `}>
             <div className={`bg-grey105 grid gap-4 md:grid md:gap-3  md:bg-grey105 `}>
                <PerformanceCard  currentYear={currentYear} years={years} id={'incomeEarned'} isSmall={false} showContainerBorder={false} percentage={'26.8'} onChangeDate={onChange} showPerformancePercentage={false} maxWidth={'100%'} title={cardTile} value={performanceValue} isValueInPercentage={false} showMonthPick={true} didValueIncrease={true}/>

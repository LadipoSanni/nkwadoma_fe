            ...
            <DialogContent id="createCohortDialogContent" className="max-w-[425px] md:max-w-[533px] [&>button]:hidden gap-8 py-5 pl-5 pr-2">
                ...
                {!isFormSubmitted ? (
                        ...
                        <div id="programDateContainer" className={'flex gap-5 w-full items-center'}>
                                ...
                                <Select onValueChange={(value) => setSelectedProgram(value)}
                                    ...
                                    <SelectTrigger
                                        ...
                                        {isSelectOpen ?
                                            ...
                                            <MdKeyboardArrowDown
                                                className="h-[22px] w-[22px] text-neutral950"/>}
                                    </SelectTrigger>
                            ...
                            <div id="dateContainer" className={'grid gap-2 w-full'}>
                                ...
                                <Popover>
                                    ...
                                    <PopoverContent id="datePopoverContent" className="w-auto p-0">
                                        <Calendar
                                            mode="single"
                                            selected={date}
                                            onSelect={setDate}
                            ...
                            >
                                ...
                                <div id="uploadTextContainer" className={'grid gap-1 place-items-center'}>
                                    <p className={'font-normal text-black400 text-[14px] leading-[150%]'}><span
                                        className={'underline text-meedlBlue'}>Click to upload</span> or drag
                                        and drop
                                    </p>
                                    <p className={'text-grey250 leading-[150%] text-[14px] font-normal'}>SVG,
                                        PNG, JPG
                                        OR GIF (max. 800x400px) </p>
                                </div>
                            </div>
                        </div>
                        <div id="formButtonsContainer" className={'flex gap-5 mt-3 justify-end items-end sticky inset-0 bg-white p-4'}>
                            <Button
                                id="cancelButton"
                    ...
                    <main id="feeBreakdownContainer" className={'grid gap-5'}>
                        ...
                        <div id="initialItemContainer" className="flex gap-5">
                            ...
                            <div className="grid gap-2">
                                ...
                                <div className="flex gap-2">
                                    <Select>
                                        <SelectTrigger id="initialItemSelectTrigger" className={'mt-0 mb-0 min-w-[78px]'}>
                                    ...
                                    <Input type="number" id={`itemAmount-`} name={`itemAmount`}
                                           placeholder="Amount"
                                           className="p-4 focus-visible:outline-0 w-[132px] shadow-none focus-visible:ring-transparent rounded-md h-[3.375rem] font-normal leading-[21px] text-[14px] placeholder:text-grey150 text-black500 border border-solid border-neutral650"
                                    />
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <div className={'flex justify-between gap-2 items-center'}>
                                            <Input type="number" id={`itemAmount${index}`} name={`itemAmount-${index}`}
                                                   placeholder="Amount"
                                                   className="p-4 focus-visible:outline-0 w-[132px] shadow-none focus-visible:ring-transparent rounded-md h-[3.375rem] font-normal leading-[21px] text-[14px] placeholder:text-grey150 text-black500 border border-solid border-neutral650"
                                                   value={item.amount}
                                                   onChange={(e) => {
                                            ...
                                            <MdOutlineDelete id={`deleteItemButton${index}`} className={'text-error450 h-4 w-4 cursor-pointer'}
                        ...
                        <section id="addItemSection" onClick={handleSelectClick} className={'cursor-pointer flex gap-1'}>

    ...
    return (
        <Providers>
            ...
            >
                ...
                <div
                    className={` ${styles.authLayoutChildrenDiv} md:grid grid gap-1 w-full md:w-full py-6 px-4   h-full md:h-full bg-authBg md:bg-authBg  `}
                >
                    <div
                        id={'authLayoutOrganizationLogo'}
                        data-testid={`authLayoutOrganizationLogo`}
                    ...
                    <div id={`authLayoutChildrenDiv`}
                         ...
                         className={`   w-full h-fit md:w-[55%]  md:absolute md:grid md:justify-items-end   md:mt-28 md:h-[60%]  `}
                    >
                        {children}
                    </div>
                </div>

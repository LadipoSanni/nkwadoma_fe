...
const Details = ({id, name, value,sx, valueType,showAsWholeNumber, isLoading}: Props) => {
    return (
        <div id={id} data-testid={id} className={`md:border  h-fit bg-white grid w-fit md:w-full lg:w-full   rounded-md px-3 py-4  md:border-grey-200 border border-grey-200 `}>

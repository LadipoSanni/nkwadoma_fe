...
import {LoaneeBasicDetails} from "@/components/loanee-my-profile/PmLoaneeLoanDetails";
...
const LoaneeBasicDetails = ({data, isLoading}: props) => {
    ...
    const basicDetails = [
        ...
        >
            {userRole === 'LOANEE'?
                <div>
                  <div id={'document'} className={`w-fit ${inter500.className} text-[18px]  py-4 h-fit   text-[#212221]  `} >Document</div>
                  <div

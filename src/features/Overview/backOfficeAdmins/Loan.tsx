...
const Loan = ({data, isLoading}:LoanProps) => {
    ...
    const loanChartData = [
        { browser: "Uploaded", visitors: data?.uploadLoanPercentage, fill: "#FBE2B7" },
        { browser: "Referred", visitors: data?.loanReferralPercentage, fill: "#D9EAFF" },
        { browser: "Offered", visitors: data?.loanOfferPercentage, fill: "#FFB0B0" },
        { browser: "Requested", visitors: data?.loanRequestPercentage, fill: "#B5DFC3" },
        { browser: "Disbursed", visitors: data?.loanDisbursalPercentage, fill: "#FCD5BC" },

...
const CohortView = () => {
    ...
    const {data: cohortData} = useGetAllCohortsByOrganisationQuery({
        pageSize: size,
        pageNumber: page
    }, {refetchOnMountOrArgChange: true,})
    const {data: searchData} = useSearchCohortByOrganisationQuery(searchTerm, {skip: !searchTerm})
    const {data: programDatas,} = useGetAllProgramsQuery({
        pageSize: size,
        pageNumber: page
    }, {refetchOnMountOrArgChange: true,})
    ...
    const {data: cohortsByProgram, refetch} = useGetAllCohortByAParticularProgramQuery({
        programId,
        pageSize: size,
        pageNumber: page
        ...
        <div className=''>
            <div id='cohortName' className='md:px-8 px-4'>
                ...
                <div id='buttonFilterCreate'
                     className={`md:flex justify-between items-center z-50 relative top-6 bottom-2 ${inter.className}`}>

...
const Step1 = () => {
    ...
    return (
            ...
            <div
                ...
                className={` py-4 border border-slate-200 px-3 w-[90vw] rounded-md h-auto bg-white grid md:px-2.5 md:grid md:place-items-center  md:border md:border-slate-200 md:w-[55%] md:h-fit md:rounded`}
            >
                <div

...
export const { useCreateCohortMutation, useViewAllLoaneeQuery, useGetAllCohortsByOrganisationQuery,useSearchCohortByOrganisationQuery, useDeleteCohortMutation, useEditCohortMutation} = cohortApi;

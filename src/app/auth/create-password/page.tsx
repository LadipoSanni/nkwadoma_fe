            ...
            <form id={'create-password-form'} className={'grid gap-[99px]'}>
                <main id={'create-password-main'} className={'grid gap-[24.14px]'}>
                    ...
                    <div id={'create-password-inputs'} className={'grid gap-4'}>
                        <CustomInputField label={'Password'} id={'password'} type={'password'} endAdornment={'Show'} placeholder={'password'}/>
                        <CustomInputField label={'Confirm Password'} id={'confirmPassword'} type={'password'} endAdornment={<VisibilityOffIcon id={`visibility-icon`} style={{ color: '#000000', width: '16px', height: '16px' }} />} placeholder={'Enter password'}/>
                    </div>
                </main>
                {/*<button*/}

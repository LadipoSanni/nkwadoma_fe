...
# Define URLs for your project
SONARQUBE_URL=http://sonarqube.example.com/dashboard?id=my-nodejs-project
# Maven is not used for Node.js; you can remove the Maven report URL if not applicable
# MAVEN_REPORT_URL=https://example.com/path/to/maven-report.html

# Define default automation test report URL if applicable
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    <div style="background-color: #d4edda; border: 1px solid #c3e6cb; border-radius: 5px; padding: 20px; margin-bottom: 20px;">
        ...
        <p style="margin-bottom: 10px;">Congratulations, your recent build for the Nkwadoma frontend project was successful.</p>
